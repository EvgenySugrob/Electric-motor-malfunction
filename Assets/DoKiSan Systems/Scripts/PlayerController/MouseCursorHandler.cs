...
public class MouseCursorHandler : MonoBehaviour
{
    ...
    [SerializeField]private MultimeterProbes multimeterProbe;
    ...
    public void SetMultimeterProbe(MultimeterProbes probe)
    {
        multimeterProbe = probe;
    }
    public MultimeterProbes GetMultimeterProbe()
    {
        return multimeterProbe;
    }
}
